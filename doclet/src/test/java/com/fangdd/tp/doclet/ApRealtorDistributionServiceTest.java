 ...
 * @date 18/1/5
 */
public class ApRealtorDistributionServiceTest extends BaseTpDocTest {
    /**
     * 需要引入的包
     */
    private static final String[] JARS = new String[]{
            ...
            "com/fangdd/fdd-common-basic/1.0.0-SNAPSHOT/fdd-common-basic-1.0.0-20180615.022920-43.jar",
    ...
    public void test() throws IOException {
        ...
        String[] docArgs = new String[]{
                "com.fangdd.ap.distribution.server.controller",
//                "-subpackages",
//                projectPath + "/server/target/tp-server.jar",
    ...
    protected String getProjectPath() {
        return "/Users/xuwenzhen/Projects/fdd/other/ap-realtor-distribution-service";
    }
}